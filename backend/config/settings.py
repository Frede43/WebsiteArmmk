...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-2*fkl^#dp#5*#f#mu)jxh^%0&bi$0@51_bvb%lp%s!!0w5y71p')
...
CSRF_TRUSTED_ORIGINS = ['https://site-armmk-backend.onrender.com']
