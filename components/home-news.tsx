        ...
        {news.length > 0 ? (
          ...
          <div className="py-24 text-center border-y border-gray-100">
             <p className="text-gray-400 font-serif italic text-xl">
               {lang === 'en' ? 'No news published yet. Come back soon!' : lang === 'es' ? 'Aún no hay noticias publicadas. ¡Vuelva pronto!' : 'Aucune actualité publiée pour le moment. Revenez bientôt !'}
             </p>
          </div>
        )}
      </div>
